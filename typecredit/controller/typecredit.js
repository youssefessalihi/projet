  ...
  function getElements() {
    ...
    $.post(
      ...
      function (result) {
            ...
            buttons: [
              {
                ...
                customize: function (doc) {
                  doc.content[0].text = "Les différents types de crédit";
          ...
          const addButton = '<button type="button" class=" dt-button " style="background-color:blue !important;color:white;" data-bs-toggle="modal" id="addModal" data-bs-target="#addModal"><i class="bi bi-plus-circle"></i> Ajouter un type de crédit </button>';
