...
class Database
{
    ...
    public function read_one()
    {
        ...
        $sql = "SELECT * from typecomposition WHERE id = ?";
    ...
    public function add_type()
    {
        ...
        $sql = "insert into typecomposition (libelle) values (?)";
        $stmt = mysqli_prepare($this->conn, $sql);
    ...
    public function update_type()
    {
        $id =  mysqli_real_escape_string($this->conn, htmlspecialchars($_POST['id']));
        $libelle = mysqli_real_escape_string($this->conn, ($_POST['libelle']));
        $sql = "UPDATE typecomposition set libelle = ?  WHERE id = ?";
        $stmt = mysqli_prepare($this->conn, $sql);
    ...
    public function delete_type()
    {
        ...
        $sql = "DELETE FROM typecomposition WHERE id = ?";
        $stmt = mysqli_prepare($this->conn, $sql);
        mysqli_stmt_bind_param($stmt, "s", $id);
