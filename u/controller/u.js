  ...
  function getElements() {
    ...
    $.post(
      ...
      function (result) {
            ...
            buttons: [
              {
                ...
                filename: `typesutilisateur${today}`,
                customize: function (doc) {
                  doc.content[0].text = "Les différents types d'utilisateur";
              ...
              },
              {
                ...
                filename: `typesUtilisateurs${today}`
              },
              {
                extend: "copy",
                exportOptions: {
          ...
          const addButton = '<button type="button" class=" dt-button " style="background-color:blue !important;color:white;" data-bs-toggle="modal" id="addModal" data-bs-target="#addModal"><i class="bi bi-plus-circle"></i> Ajouter un type d\'utilisateur </button>';
