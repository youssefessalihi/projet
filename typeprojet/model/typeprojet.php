...
class Database
{
    ...
    public function read_one()
    {
        ...
        $sql = "SELECT * from typeprojet WHERE id = ?";
    ...
    public function add_type()
    {
        ...
        $urlPin = mysqli_real_escape_string($this->conn, ($_POST['urlPin']));
        $sql = "insert into typeprojet (libelle,urlPin) values (?,?)";
        $stmt = mysqli_prepare($this->conn, $sql);
        mysqli_stmt_bind_param($stmt, "ss", $libelle,$urlPin);
    ...
    public function update_type()
    {
        ...
        $libelle = mysqli_real_escape_string($this->conn, ($_POST['libelle']));
        $urlPin = mysqli_real_escape_string($this->conn, ($_POST['urlPin']));
        $sql = "UPDATE typeprojet set libelle = ? ,urlPin=? WHERE id = ?";
        $stmt = mysqli_prepare($this->conn, $sql);
        mysqli_stmt_bind_param($stmt, "ssi" ,$libelle,$urlPin, $id);
        $result = mysqli_stmt_execute($stmt);
        if ($result) {
            echo json_encode(array('success' => true));
        } else {
    ...
    public function delete_type()
    {
        ...
        $sql = "DELETE FROM typeprojet WHERE id = ?";
        $stmt = mysqli_prepare($this->conn, $sql);
        mysqli_stmt_bind_param($stmt, "s", $id);
